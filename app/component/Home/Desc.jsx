...
const Description = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ol className="list-decimal list-inside text-gray-700 text-lg mb-8">
        <li><strong>Household Shifting</strong>: Safe and efficient relocation of your household items. We handle everything from packing fragile items to transporting heavy furniture.</li>
        <li><strong>Vehicle Transportation</strong>: Scratch-free <strong>car transportation services</strong> and <strong>bike parcel services</strong>. We use advanced packaging materials and GPS tracking to ensure your vehicle reaches its destination safely.</li>
        <li><strong>Warehousing</strong>: Secure and scalable storage solutions for your goods. Our warehouses are equipped with 24/7 surveillance and climate control systems.</li>
        <li><strong>Office Relocation</strong>: Efficient and hassle-free relocation of your office equipment, furniture, and documents. We ensure minimal downtime for your business.</li>
        <li><strong>International Moving</strong>: Relocating abroad? We offer end-to-end international moving services, including customs clearance and documentation.</li>
      </ol>

      <h2 className="text-3xl font-bold text-blue-600 mb-6">Domestic Shifting Services</h2>
      <p className="text-gray-700 text-lg mb-8">
        Our <strong>domestic shifting services</strong> are designed to make your <strong>home relocation</strong> hassle-free. From packing and loading to unloading and unpacking, we handle every step with care. Our team ensures that your belongings are safely transported to your new home, whether it’s within the city or across the country. We use high-quality packing materials to protect your items during transit, and our experienced movers ensure everything is handled with precision.
      </p>
      ...
      <ol className="list-decimal list-inside text-gray-700 text-lg mb-8">
        <li><strong>Affordable Pricing</strong>: We offer competitive rates with no hidden costs.</li>
        <li><strong>Experienced Team</strong>: Our team of professionals has years of experience in the packing and moving industry.</li>
        <li><strong>24/7 Customer Support</strong>: We’re always available to answer your queries and provide assistance.</li>
        <li><strong>Advanced Technology</strong>: From GPS tracking to secure warehousing, we use the latest technology to ensure a smooth moving experience.</li>
        <li><strong>Customized Solutions</strong>: Whether it’s <strong>household shifting</strong>, <strong>office relocation</strong>, or <strong>vehicle transportation</strong>, we offer tailored solutions to meet your specific needs.</li>
      </ol>
      ...
      <blockquote className="text-gray-700 text-lg mb-8 italic border-l-4 border-blue-600 pl-4">
